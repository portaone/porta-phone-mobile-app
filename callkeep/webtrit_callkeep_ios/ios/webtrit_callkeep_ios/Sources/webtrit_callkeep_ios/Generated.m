...
- (NSUInteger)hash {
  ...
  result = result * 31 + FLTPigeonDeepHash(self.localizedName);
  result = result * 31 + FLTPigeonDeepHash(self.ringtoneSound);
  result = result * 31 + FLTPigeonDeepHash(self.ringbackSound);
  result = result * 31 + FLTPigeonDeepHash(self.iconTemplateImageAssetName);
  result = result * 31 + @(self.maximumCallGroups).hash;
  result = result * 31 + @(self.maximumCallsPerCallGroup).hash;
  result = result * 31 + FLTPigeonDeepHash(self.supportsHandleTypeGeneric);
  result = result * 31 + FLTPigeonDeepHash(self.supportsHandleTypePhoneNumber);
  result = result * 31 + FLTPigeonDeepHash(self.supportsHandleTypeEmailAddress);
...
- (BOOL)isEqual:(id)object {
  ...
  WTPAndroidOptions *other = (WTPAndroidOptions *)object;
  return FLTPigeonDeepEquals(self.ringtoneSound, other.ringtoneSound) && FLTPigeonDeepEquals(self.ringbackSound, other.ringbackSound);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"WTPAndroidOptions(ringtoneSound: %@, ringbackSound: %@)", self.ringtoneSound, self.ringbackSound];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  WTPOptions *other = (WTPOptions *)object;
  return FLTPigeonDeepEquals(self.ios, other.ios) && FLTPigeonDeepEquals(self.android, other.android);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.ios);
  result = result * 31 + FLTPigeonDeepHash(self.android);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"WTPOptions(ios: %@, android: %@)", self.ios, self.android];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  WTPHandle *other = (WTPHandle *)object;
  return self.type == other.type && FLTPigeonDeepEquals(self.value, other.value);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"WTPHandle(type: %ld, value: %@)", (long)self.type, self.value];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  WTPEndCallReason *other = (WTPEndCallReason *)object;
  return self.value == other.value;
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + @(self.value).hash;
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"WTPEndCallReason(value: %ld)", (long)self.value];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  WTPIncomingCallError *other = (WTPIncomingCallError *)object;
  return self.value == other.value;
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"WTPIncomingCallError(value: %ld)", (long)self.value];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  WTPCallRequestError *other = (WTPCallRequestError *)object;
  return self.value == other.value;
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"WTPCallRequestError(value: %ld)", (long)self.value];
}
@end
