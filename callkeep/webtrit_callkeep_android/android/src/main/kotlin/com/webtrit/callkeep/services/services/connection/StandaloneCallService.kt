...
class StandaloneCallService : Service() {
    ...
    private fun handleEstablishCall(metadata: CallMetadata) {
        ...
        ringtoneManager.stopRingtone()
        ringtoneManager.stopCallWaitingTone()
        val connection = connectionFor(metadata)
    ...
    private fun handleUpdateCall(metadata: CallMetadata) {
        ...
        connectionFor(metadata).updateMetadata(updated)
    }
    ...
    companion object {
        ...
        private fun connectionFor(metadata: CallMetadata): CallConnection = connections.getOrPut(metadata.callId) { CallConnection(metadata) }
