...
|---|---|---|
| `WEBTRIT_APP_CDRS_HISTORY_FIRST_WINDOW_DAYS` | 7 | width of the slice next to the cursor |
| `WEBTRIT_APP_CDRS_HISTORY_MAX_WINDOW_DAYS` | 90 | ceiling the width doubles up to |
