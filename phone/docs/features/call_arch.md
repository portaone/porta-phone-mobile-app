...
diagrams in [`../incoming_call_scenarios.md`](../incoming_call_scenarios.md); merging calls into a
room, and what that does to each of them, in [`call_conference.md`](call_conference.md).
