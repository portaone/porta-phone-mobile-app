...
## Development & Build
 ...
 - **Contact lookup by number**: See [Finding the contact a phone number belongs to](docs/contact_lookup_by_number.md) for the exact-then-ending lookup, the two invariants that keep it from naming the wrong person, and what it deliberately does not do.
