...
class AppConfig with _$AppConfig {
  ...
  /// JSON Schema (draft 2020-12) of the app config contract, generated by
  /// json_serializable's `create_json_schema` option.
  static final Map<String, Object?> jsonSchema = assembleNullability(
    assembleEnums(assembleUnions(_$AppConfigJsonSchema, unionVariants), 'AppConfig', enumProperties),
    'AppConfig',
    nullableProperties,
  );
...
class AppConfigIce with _$AppConfigIce {
  const AppConfigIce({this.certificateVerification = 'auto', this.certificateVerificationConfigurable = false});
...
class FavoritesTabScheme extends BottomMenuTabScheme with _$FavoritesTabScheme {
  ...
  static const Map<String, Object?> jsonSchema = _$FavoritesTabSchemeJsonSchema;
}
...
class RecentsTabScheme extends BottomMenuTabScheme with _$RecentsTabScheme {
  ...
  static const Map<String, Object?> jsonSchema = _$RecentsTabSchemeJsonSchema;
}
...
class ContactsTabScheme extends BottomMenuTabScheme with _$ContactsTabScheme {
  ...
  static const Map<String, Object?> jsonSchema = _$ContactsTabSchemeJsonSchema;
}
...
class KeypadTabScheme extends BottomMenuTabScheme with _$KeypadTabScheme {
  ...
  static const Map<String, Object?> jsonSchema = _$KeypadTabSchemeJsonSchema;
}
...
class MessagingTabScheme extends BottomMenuTabScheme with _$MessagingTabScheme {
  ...
  static const Map<String, Object?> jsonSchema = _$MessagingTabSchemeJsonSchema;
}
...
class EmbeddedTabScheme extends BottomMenuTabScheme with _$EmbeddedTabScheme {
  ...
  static const Map<String, Object?> jsonSchema = _$EmbeddedTabSchemeJsonSchema;
}
