...
@useResult
$Res call({
 String id, String date, double duration, String sender, String receiver, bool seen, int size, String type, List<UserVoicemailAttachment> attachments, bool? saved, String? forwardedBy
});
