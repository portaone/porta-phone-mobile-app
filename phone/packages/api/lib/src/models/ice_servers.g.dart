...
IceServersResponse _$IceServersResponseFromJson(Map<String, dynamic> json) => IceServersResponse(
  iceServers:
...
Map<String, dynamic> _$IceServersResponseToJson(IceServersResponse instance) => <String, dynamic>{
