...
PrefixMatcher _$PrefixMatcherFromJson(Map<String, dynamic> json) =>
    PrefixMatcher(prefix: json['prefix'] as String, number: json['number'] as String);

Map<String, dynamic> _$PrefixMatcherToJson(PrefixMatcher instance) => <String, dynamic>{
  'prefix': instance.prefix,
  'number': instance.number,
};

CallerIdSettings _$CallerIdSettingsFromJson(Map<String, dynamic> json) => CallerIdSettings(
...
Map<String, dynamic> _$CallerIdSettingsToJson(CallerIdSettings instance) => <String, dynamic>{
