...
class WebtritApiClient {
  ...
  Future<void> deleteUserVoicemail(
    ...
    final pathSegments = [..._apiBasePathSegmentsV1, 'user', 'voicemails', messageId];
    final headers = locale != null ? {'Accept-Language': locale} : null;

    if (permanent) {
      return _httpClientExecuteDelete(
        pathSegments,
        headers,
        token,
