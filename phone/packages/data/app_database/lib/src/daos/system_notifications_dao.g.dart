...
mixin _$SystemNotificationsDaoMixin on DatabaseAccessor<AppDatabase> {
  $SystemNotificationsTableTable get systemNotificationsTable => attachedDatabase.systemNotificationsTable;
  $SystemNotificationsOutboxTableTable get systemNotificationsOutboxTable =>
      attachedDatabase.systemNotificationsOutboxTable;
  SystemNotificationsDaoManager get managers => SystemNotificationsDaoManager(this);
}
...
class SystemNotificationsDaoManager {
  ...
  $$SystemNotificationsTableTableTableManager get systemNotificationsTable =>
      $$SystemNotificationsTableTableTableManager(_db.attachedDatabase, _db.systemNotificationsTable);
  $$SystemNotificationsOutboxTableTableTableManager get systemNotificationsOutboxTable =>
      $$SystemNotificationsOutboxTableTableTableManager(_db.attachedDatabase, _db.systemNotificationsOutboxTable);
}
