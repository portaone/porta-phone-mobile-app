...
mixin _$FavoritesV2DaoMixin on DatabaseAccessor<AppDatabase> {
  $FavoritesV2TableTable get favoritesV2Table => attachedDatabase.favoritesV2Table;
  $FavoritesOutboxTableTable get favoritesOutboxTable => attachedDatabase.favoritesOutboxTable;
...
class FavoritesV2DaoManager {
  ...
  $$FavoritesV2TableTableTableManager get favoritesV2Table =>
      $$FavoritesV2TableTableTableManager(_db.attachedDatabase, _db.favoritesV2Table);
  $$FavoritesOutboxTableTableTableManager get favoritesOutboxTable =>
      $$FavoritesOutboxTableTableTableManager(_db.attachedDatabase, _db.favoritesOutboxTable);
