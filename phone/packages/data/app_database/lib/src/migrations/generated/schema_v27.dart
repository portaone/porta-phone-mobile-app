...
class CdrHistoryWalk extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CdrHistoryWalk(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  CdrHistoryWalk createAlias(String alias) {
    return CdrHistoryWalk(attachedDatabase, alias);
  }
...
class DatabaseAtV27 extends GeneratedDatabase {
  ...
  late final CdrHistoryWalk cdrHistoryWalk = CdrHistoryWalk(this);
