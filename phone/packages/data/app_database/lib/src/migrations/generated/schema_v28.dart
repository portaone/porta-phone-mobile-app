...
class ChatUserSettings extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ChatUserSettings(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> chatId = GeneratedColumn<int>(
    'chat_id',
    aliasedName,
    false,
  ...
  @override
  ChatUserSettings createAlias(String alias) {
    return ChatUserSettings(attachedDatabase, alias);
  }
...
class SmsConversationUserSettings extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SmsConversationUserSettings(this.attachedDatabase, [this._alias]);
  ...
  @override
  SmsConversationUserSettings createAlias(String alias) {
    return SmsConversationUserSettings(attachedDatabase, alias);
  }
...
class SipSubscriptions extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SipSubscriptions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> type = GeneratedColumn<String>(
    'type',
    aliasedName,
    false,
  ...
  @override
  SipSubscriptions createAlias(String alias) {
    return SipSubscriptions(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(type, number)'];
  @override
  bool get dontWriteConstraints => true;
}

class SipSubscriptionsOutbox extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SipSubscriptionsOutbox(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> action = GeneratedColumn<String>(
    'action',
    aliasedName,
    false,
  ...
  @override
  SipSubscriptionsOutbox createAlias(String alias) {
    return SipSubscriptionsOutbox(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY("action", type, number)',
  ];
  @override
  bool get dontWriteConstraints => true;
}
...
class Voicemails extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> saved = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL CHECK (saved IN (0, 1))',
  );
...
class SystemNotifications extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SystemNotifications(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> seen = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL CHECK (seen IN (0, 1))',
  );
  late final GeneratedColumn<int> createdAtRemoteUsec = GeneratedColumn<int>(
    'created_at_remote_usec',
    aliasedName,
  ...
  @override
  SystemNotifications createAlias(String alias) {
    return SystemNotifications(attachedDatabase, alias);
  }
...
class SystemNotificationsOutbox extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SystemNotificationsOutbox(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> notificationId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL REFERENCES system_notifications(id)ON DELETE CASCADE',
  );
  ...
  @override
  SystemNotificationsOutbox createAlias(String alias) {
    return SystemNotificationsOutbox(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(notification_id, action_type)',
  ];
  @override
  bool get dontWriteConstraints => true;
}
...
class PresenceInfo extends Table with TableInfo {
  ...
  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(number, source, id_key)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class DialogInfo extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DialogInfo(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> idKey = GeneratedColumn<String>(
    'id_key',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> hasVideo = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL CHECK (has_video IN (0, 1))',
  );
  @override
  List<GeneratedColumn> get $columns => [
    idKey,
  ...
  @override
  DialogInfo createAlias(String alias) {
    return DialogInfo(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(entity_number, id_key)',
  ];
  @override
  bool get dontWriteConstraints => true;
}
...
class Cdrs extends Table with TableInfo {
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Cdrs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> callId = GeneratedColumn<String>(
    'call_id',
    aliasedName,
    false,
  ...
  @override
  Cdrs createAlias(String alias) {
    return Cdrs(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(call_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class CdrSyncCursors extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CdrSyncCursors(this.attachedDatabase, [this._alias]);
  ...
  @override
  CdrSyncCursors createAlias(String alias) {
    return CdrSyncCursors(attachedDatabase, alias);
  }
...
class DatabaseAtV28 extends GeneratedDatabase {
  ...
  late final ChatUserSettings chatUserSettings = ChatUserSettings(this);
  ...
  late final SmsConversationUserSettings smsConversationUserSettings =
      SmsConversationUserSettings(this);
  ...
  late final SipSubscriptions sipSubscriptions = SipSubscriptions(this);
  late final SipSubscriptionsOutbox sipSubscriptionsOutbox =
      SipSubscriptionsOutbox(this);
  ...
  late final SystemNotifications systemNotifications = SystemNotifications(
    this,
  );
