...
abstract class AppLocalizations {
  ...
  /// No description provided for @settings_certificateVerification_auto.
  ///
  /// In en, this message translates to:
  /// **'Automatic'**
  String get settings_certificateVerification_auto;

  /// No description provided for @settings_certificateVerification_enabled.
  ///
  /// In en, this message translates to:
  /// **'Always verify'**
  String get settings_certificateVerification_enabled;
