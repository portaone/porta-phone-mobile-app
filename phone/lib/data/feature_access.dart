...
abstract final class CallMapper {
  ...
  static CallConfig map(AppConfig appConfig, FeatureOverrides featureOverrides, WebtritSystemInfo? systemInfo) {
    ...
    return CallConfig(
      ...
      // An unrecognised value reads as `verify` rather than raising: a build
      // must not refuse to start because a configuration names a policy it does
      // not know, and `verify` is the answer that changes nothing.
      ice: IceConfig(
