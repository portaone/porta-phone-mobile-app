    ...
    for (final action in actions) {
      switch (action) {
        ...
        case DeliverOfferAction():
          // The same handler: it stores the offer in the call that waits for
          // it and reports the call to callkeep a second time, which answers
          // callIdAlreadyExists* and is handled there.
