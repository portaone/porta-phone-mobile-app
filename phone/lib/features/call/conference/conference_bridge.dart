...
final _logger = Logger('ConferenceBridge');
...
/// from the SIP side - so the bridge is one more connection next to them,
...
class ConferenceBridge {
  ...
  /// Runs [action] after whatever the bridge is already doing.
