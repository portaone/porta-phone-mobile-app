...
mixin _$ActiveCall {
 ...
 CallDirection get direction; int? get line; String get callId; CallkeepHandle get handle; DateTime get createdTime; bool get video; bool get videoPermissionDenied; CallProcessingStatus get processingStatus; bool? get frontCamera; bool get held; bool get muted; bool get updating; JsepValue? get incomingOffer; String? get displayName; String? get fromReferId; String? get fromReplaces; String? get fromNumber; DateTime? get acceptedTime; DateTime? get hungUpTime; Transfer? get transfer; Object? get failure; MediaStream? get localStream; MediaStream? get remoteStream; bool? get remoteCameraEnabled; bool? get speakerOnBeforeMinimize; List<RTCIceCandidate> get iceCandidates; IceConnectionIssue? get iceConnectionIssue; CallNetworkQuality? get networkQuality; bool get earlyMedia;
...
@override
int get hashCode => Object.hashAll([runtimeType,direction,line,callId,handle,createdTime,video,videoPermissionDenied,processingStatus,frontCamera,held,muted,updating,incomingOffer,displayName,fromReferId,fromReplaces,fromNumber,acceptedTime,hungUpTime,transfer,const DeepCollectionEquality().hash(failure),localStream,remoteStream,remoteCameraEnabled,speakerOnBeforeMinimize,const DeepCollectionEquality().hash(iceCandidates),iceConnectionIssue,networkQuality,earlyMedia]);

@override
String toString() {
  return 'ActiveCall(direction: $direction, line: $line, callId: $callId, handle: $handle, createdTime: $createdTime, video: $video, videoPermissionDenied: $videoPermissionDenied, processingStatus: $processingStatus, frontCamera: $frontCamera, held: $held, muted: $muted, updating: $updating, incomingOffer: $incomingOffer, displayName: $displayName, fromReferId: $fromReferId, fromReplaces: $fromReplaces, fromNumber: $fromNumber, acceptedTime: $acceptedTime, hungUpTime: $hungUpTime, transfer: $transfer, failure: $failure, localStream: $localStream, remoteStream: $remoteStream, remoteCameraEnabled: $remoteCameraEnabled, speakerOnBeforeMinimize: $speakerOnBeforeMinimize, iceCandidates: $iceCandidates, iceConnectionIssue: $iceConnectionIssue, networkQuality: $networkQuality, earlyMedia: $earlyMedia)';
}
...
@useResult
$Res call({
 CallDirection direction, int? line, String callId, CallkeepHandle handle, DateTime createdTime, bool video, CallProcessingStatus processingStatus, bool videoPermissionDenied, bool? frontCamera, bool held, bool muted, bool updating, JsepValue? incomingOffer, String? displayName, String? fromReferId, String? fromReplaces, String? fromNumber, DateTime? acceptedTime, DateTime? hungUpTime, Transfer? transfer, Object? failure, MediaStream? localStream, MediaStream? remoteStream, bool? remoteCameraEnabled, bool? speakerOnBeforeMinimize, List<RTCIceCandidate> iceCandidates, IceConnectionIssue? iceConnectionIssue, CallNetworkQuality? networkQuality, bool earlyMedia
});
