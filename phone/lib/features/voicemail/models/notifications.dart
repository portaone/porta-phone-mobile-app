...
/// the backend answered - declared on [VoicemailAction], which needs a constant.
Notification voicemailDeleteFailed(RequestFailure? failure) => VoicemailDeleteFailedNotification(failure);

Notification voicemailRestoreFailed(RequestFailure? failure) => VoicemailRestoreFailedNotification(failure);

Notification voicemailUpdateFailed(RequestFailure? failure) => VoicemailUpdateFailedNotification(failure);
