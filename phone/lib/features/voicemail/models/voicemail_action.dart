...
enum VoicemailAction {
  ...
  /// What the person is told when it did not happen, given what the backend
  /// answered - null where it answered nothing at all.
  ///
  /// Only for a refusal that says nothing about the message: one that says the
  /// message is gone has a sentence of its own. The failure is carried into the
  /// notification rather than into the sentence - it is what the details behind
  /// it are made of.
  final Notification Function(RequestFailure? failure) whenFailed;
