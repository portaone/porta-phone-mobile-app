...
void main() {
  ...
  // covered by test/common/process_role_test.dart; these check the forwarder is wired to it.
    ...
    List<String> startForwarder(String name, {bool takeOver = false}) {
      ...
      forwarders.add(
        NativeLogForwarder(
          ...
          logger: logger,
          takeOver: takeOver,
          role: ProcessRole(roleName, probeTimeout: const Duration(milliseconds: 50)),
        )..start(),
      );
      return lines;
    }
