...
void main() {
  ...
  setUp(() {
    ...
    purpose = BlindTransferPurpose(announcement: 'Performing blind transfer', controller: controller);
  });
  ...
  test('two purposes over the same call are the same purpose', () {
    ...
    // list on the screen.
    final other = BlindTransferPurpose(announcement: 'Performing blind transfer', controller: controller);
